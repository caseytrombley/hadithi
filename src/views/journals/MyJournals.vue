...
export default {
  ...
  methods: {
    ...
    async getItems() {
      let myJournals = await JournalService.getJournalsByEmail(this.creatorEmail);
      myJournals = booleanFieldSort(myJournals, "isFree");
      return timestampFieldSort(myJournals, "updatedAt");
    },
    ...
    async handleDelete(document) {
      if (confirm("Are you sure you want to delete?")) {
        await JournalService.deleteJournal(document.id);
        this.$router.go(0);
      }
    },
  },
