          ...
          <div class="text-start col-lg-6 col-md-8 col-sm-12 m-auto border rounded p-4" onsubmit="return false">
            <div class="mb-3">
              ...
              <input class="d-flex col-12 form-input p-2" type="text" v-model="resource.title"
                     @change="toggleDisabledSaveButton(false)" :maxlength="maxTitleChars"
            ...
            <div class="mb-3">
              ...
              <input type="file" required placeholder="Upload resource" class="form-control" accept="application/pdf"
