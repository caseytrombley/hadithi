<template>
  <div id="audio-player-root">
    ...
    <div class="audio bg-gray-200 shadow-md">
  ...
  mounted: function () {
    ...
    this.$nextTick(function () {
      ...
      this.$watch("playbackTime", function () {
        ...
        const diff = Math.abs(this.playbackTime - player.currentTime);
...
/*don't use tailwind here please, causes css bugs across site*/
